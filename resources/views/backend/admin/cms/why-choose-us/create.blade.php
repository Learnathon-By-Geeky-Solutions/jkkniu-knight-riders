                ...
                <div class="card-style settings-card-1 mb-30">
                    <div class="profile-info">
                        <div class="card card-body mt-4">
                            <h2 class="h5 fw-semibold mb-4 text-center">Add Why Choose Us Card</h2>
                            <form method="post" action="{{ route('cms.home.why-choose-us.store') }}" enctype="multipart/form-data">
                                @csrf
